...
object CadenceRunner {
  def main(args: Array[String]) {
    val tonic: Tone = new A(0)
    
    val arpeggio0: Arpeggio = new Arpeggio(List(List(0), List(1/4.0, 3/4.0), List(2/4.0)), 1)
    val arpeggio1: Arpeggio = new Arpeggio(List(0::Nil, (3/8.0)::(7/8.0)::Nil, (4/8.0)::Nil), 1)
    val arpeggio2: Arpeggio = new Arpeggio(List(List(0, 1, 2),
    ...
    new MelodyReader(new Cadence(tonic, arpeggio0, tempo))
